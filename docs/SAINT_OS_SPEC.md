...
├── VERSION
│
├── docs/                             # Top-level architectural notes
│   ├── HARDWARE.md
│   └── SAINT_OS_SPEC.md
│
...
│
├── configs/                          # Operator-tunable peripheral configs
│   └── roboclaw/
│       └── OpenSAINT.cfg
│
├── scripts/                          # Top-level dist/release scripts
│   └── build-local-dist.sh
│
└── server/                           # ROS2 ament package (name=saint_os)
    ├── CMakeLists.txt                # Unified build configuration
    ├── package.xml                   # <name>saint_os</name>
    ├── setup.py
│
├── config/
